...
const handler = async (req, res) => {
  ...
  try {
    const result = await (0,_lib_player__WEBPACK_IMPORTED_MODULE_1__/* .updatePreferences */ .ex)(name, numQuestions, gender);
...
var __webpack_exports__ = __webpack_require__.X(0, [190], function() { return __webpack_exec__(6843); });
